    ...
    <main className="main">
      ...
      <section className="section">
        <div className="banner flex">
          <img
            className=" w-1/2 h-64 md:h-auto md:w-1/2 object-cover"
            alt="19"
            src="/image 19.png"
          />
          <img
            className="relative w-1/2 h-64 md:h-auto md:w-1/2 object-cover"
            alt="20"
            src="/image 20.png"
          />
        </div>
      ...
      <section className="section py-8 bg-[#CEF53D] text-black">
        <div className="container mx-[auto] my-0">
          ...
          <div className="content-wrapper flex flex-wrap">
            <div className="content-left w-[37%] flex">
      ...
      <section className="section py-8 bg-[#CEF53D] text-black">
        <div className="container mx-[auto] my-0">
          ...
          {/* <div className="content-wrapper mt-10">
            <ul className="photography flex flex-wrap justify-between">
              <li className="photography-item w-[30%]">
                <div className="photography-work">
                  ...
                  <div className="flex justify-between p-4">
                    ...
                    <div>
                      <Link
                        to="/project"
                        className="text-right text-14px border-b border-black pb-2"
                      >
                        VIEW PROJECT
                      </Link>
                    </div>
